<template>
    <div
        class="w-full h-16 flex justify-between items-center px-5 py-3 shadow-md bg-stone-300 text-lg overflow-hidden"
    >
        <div>
        ...
        <div
            ...
            class="flex justify-between items-center gap-x-5 font-semibold"
        >
            <a
                class="hover:font-bold hover:text-stone-700"
