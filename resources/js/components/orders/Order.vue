    ...
    >
        ...
        >
            <div class="flex justify-between items-center">
                ...
                <h1
                    class="text-lg font-bold px-3 py-1 rounded-md border"
            ...
            <div class="border border-stone-200 p-5 mt-10 mb-20">
                <ul class="list-disc pl-5 text-xl font-bold">
                    ...
                    <li>
                        Total:
                        <span class="font-semibold">{{ order.total }} DA</span>
                    </li>
                </ul>
            </div>
...
const getStatusStyle = () => {
    if (props.order.status == "pending")
        return "text-stone-700 bg-stone-200 border-stone-500";
...
const canCancel = ref(
    props.order.status == "pending" || props.order.status == "accepted",
);
