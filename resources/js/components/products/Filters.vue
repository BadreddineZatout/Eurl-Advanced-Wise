<template>
    <div class="w-full border border-stone-300 bg-stone-200 my-5 flex justify-around items-center py-5 rounded-lg">
        <div class="w-1/3 flex items-center gap-x-2">
            ...
            <button v-show="supplier" @click="clearSupplier"
                class="text-xl font-semibold hover:font-bold hover:text-stone-600">X</button>
        </div>
        <div class="w-1/3 flex items-center gap-x-2">
