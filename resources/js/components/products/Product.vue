    ...
    >
        ...
        >
            <div class="flex justify-between items-center">
                ...
                <h1 v-show="isOnDetails" class="text-3xl font-bold">
                    {{ product.price }} DZD
                </h1>
            </div>
            ...
            <div v-show="isOnOrder">
                <form>
                    <div class="grid mt-10 mb-5">
                        <label class="font-semibold mb-2" for="quantity"
                            >Quantity :</label
                        >
                        <input
                            class="rounded-md border border-gray-500 bg-inherit px-3 py-2"
                            id="quantity"
                            name="quantity"
                            type="number"
                            min="1"
                    ...
                    <div
                        class="text-center mt-2 flex justify-between items-center gap-x-2 absolute bottom-2 w-full pr-4"
                    >
                        <button
                            class="w-1/2 bg-stone-300 font-bold text-xl py-2 hover:bg-stone-500 hover:text-white"
